...
export const NavigationLayout = ({ children, currentPage = "dashboard", onPageChange }) => {
  ...
  <div className="flex h-16 items-center justify-between px-4 md:px-6">
    ...
    <div className="flex items-center gap-2 md:gap-4">
      ...
      {/* Mobile menu button */}
      <Button className="md:hidden p-2" onClick={() => setSidebarOpen(!isSidebarOpen)}>
    <Settings className="h-5 w-5" />
      ...
      {/* Sidebar */}
      <aside className={`fixed top-16 left-0 bottom-0 w-64 border-r border-border bg-card overflow-y-auto transition-transform duration-300
